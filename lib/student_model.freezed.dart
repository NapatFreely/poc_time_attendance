...
class _$StudentModelImpl implements _StudentModel {
  ...
  @override
  String toString() {
    return 'StudentModel(id: $id, firstName: $firstName, lastName: $lastName, nickName: $nickName, studentId: $studentId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, firstName, lastName, nickName, studentId);
...
abstract class _StudentModel implements StudentModel {
  const factory _StudentModel(
      ...
      required final String studentId}) = _$StudentModelImpl;
